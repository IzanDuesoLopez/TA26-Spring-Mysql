...
public class ProductoController {
	...
	public Producto productoXCodigo(@PathVariable(name="codigo") int codigo) {
		Producto producto = new Producto();
		producto = productoServiceImpl.productoXCodigo(codigo);
		return producto;
	}
	...
	public Producto actualizarProducto(@PathVariable(name="codigo") int codigo, @RequestBody Producto producto) {
		...
		producto_seleccionado = productoServiceImpl.productoXCodigo(codigo);
